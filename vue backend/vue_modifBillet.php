...
<body>
	...
	<div class="blocTexte">
		...
		<form name="formulaire" id="formulaire" action="c_billet.php?section=7.4.1&Billet=<?php echo($id);?>" method="post">
			<label for="titre">Titre</label>
			<input type="text" name="nvtitre" value="<?php echo($titre); ?>">
			<textarea id="texte" name="nvtexte" rows="10"><?php echo($contenu); ?></textarea>
			<br />
		</form>
	</div>
