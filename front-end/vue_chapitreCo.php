		...
		<div>
			...
			<?php
				...
				while ($com = $coms->fetch()) {
					if ($com['id_billet']==$_GET['billet']) {
					echo "<p>".$com['date_ajout']." | ".$com['pseudo']." : " . $com['texte'] . "</p>" .
						"<p> <a href='c_commentaires.php?section=a.2&idcom=" . $com['id'] . "&billet=". $_GET['billet'] . "'>Signaler</a></p> ";
					}
					
				}
			?>

			<form method='post' action='c_commentaires.php?section=a.1&billet=<?php echo ($_GET['billet']); ?>'>
				<label>Laissez moi un commentaires ;)</label>
				<br><br>
